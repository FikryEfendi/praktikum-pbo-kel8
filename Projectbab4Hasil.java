...
public class Projectbab4Hasil {
    //panggil method2 di main
    ...
    //method percabangan (if, else if, switch)
    ...
    //method perulangan (for, while, do while, nested loop)
    ...
    //method control statement (break dan continue)
