...
public class SidebarUtil {
    ...
    public static JPanel createAdminSidebar(MainAppFrame parentFrame, String activeView) {
        ...
        logoPanel.setBorder(new EmptyBorder(UITheme.PADDING_LARGE, UITheme.PADDING_SMALL, 
                                           UITheme.PADDING_LARGE, UITheme.PADDING_SMALL));
        ...
        menuPanel.add(createSidebarButton(parentFrame, "Daftar Buku", MainAppFrame.DAFTAR_BUKU, activeView));
        menuPanel.add(Box.createVerticalStrut(UITheme.SPACING_SMALL));
        menuPanel.add(createSidebarButton(parentFrame, "Peminjaman Aktif", MainAppFrame.PEMINJAMAN_AKTIF, activeView));
        menuPanel.add(Box.createVerticalStrut(UITheme.SPACING_SMALL));
        menuPanel.add(createSidebarButton(parentFrame, "Riwayat", MainAppFrame.RIWAYAT_PEMINJAMAN, activeView));
    ...
    private static JButton createSidebarButton(MainAppFrame parentFrame, String text, 
                                               String viewName, String activeView) {
        ...
        button.setBorder(new EmptyBorder(UITheme.PADDING_SMALL, UITheme.PADDING_MEDIUM, 
